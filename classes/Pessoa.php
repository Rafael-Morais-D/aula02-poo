<?php
    ...
    abstract class Pessoa implements IMC {
        ...
        public function __construct($peso, $altura) {
            ...
            // Estamos atrelando o valor do parâmetro $peso (recebido no momento em que instanciamos um objeto a partir dessa classe ou de uma classe filha) à propriedade peso. Para fazermos isso, usamos o $this, de modo que a propriedade seja atralada ao objeto instanciado.
            $this->peso = $peso;
            $this->altura = $altura;
