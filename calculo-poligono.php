    ...
    <section class="row py-5">
        ...
        <?php else : ?>
            ...
            <?php
                ...
                /*
                 * DESAFIO +> Instanciar as classes de acordo com os dados recebidos por POST
                 * Dicas:
                 * - O número de argumentos é 2: forma e medidas
                 * - Medidas deve ser um array com cada uma das medidas
                 * - O número de índices do array é definido por nós mesmos (não há validação)
                 * - Vamos usar o switch
                 * - Dentro do switch devemos definir uma variável com o 'nome da medida' para popularmos a tabela (ex.: Raio, Lados, Diagonais)
                */
                ...
                switch ($_POST["poligono"]) {
                    ...
                    break;
                    default:
                        echo "Ops! Não encontramos esse polígono! Tente novamente";
                    break;
                }
